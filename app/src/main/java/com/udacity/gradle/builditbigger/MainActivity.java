...
public class MainActivity extends AppCompatActivity implements JokeListener {
    ...
    public void tellJoke(View view) {
        //CALL THE ASYNC TASK "EndpointAsyncTask.java"
    ...
    public void onResult(String result) {
        ...
        Intent intent = new Intent(this, DisplayJokeFromIntent.class);
        intent.putExtra(DisplayJokeFromIntent.JOKE_ID, result);
